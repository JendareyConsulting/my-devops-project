...
<body>
    ...
    <h2 align="center">Working to improve you!</h2>
    ...
    <h3 style="text-align: center;">Learn Essential DevOps Tools in 16 Weeks:</h3>
    <h4>
    ...
    <div style="text-align: center;">
        ...
        <h3><span style="font-weight: bold;">Jendarey Consulting, Dallas, Texas, United States +1 682 298 8089, ak@jendareyconsulting.com</h3>
    ...
    <h4><a href="receipt.html">Read More</a></h4>
    <h4><a href="registration.html">Registration</a></h4>
</body>
</html>
